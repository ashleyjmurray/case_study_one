...
second_approach <- function() {
  z_censored ~ dpois(phi_censored)
  phi_censored <- mu_censored * pow(t_censored, r)
  mu_censored <- exp(beta_censored)
  beta_censored <- beta_0 + beta_1*x_1_censored + beta_2*x_2_censored + beta_3*x_3_censored + beta_4*x_4_censored + beta_5*x_5_censored
...
x_5_censored <- x_5[1]
#
survival_non_censored <- survival[-1] # Remove Benedict
x_1_non_censored <- x_1[-1]
x_2_non_censored <- x_2[-1]
x_3_non_censored <- x_3[-1]
x_4_non_censored <- x_4[-1]
x_5_non_censored <- x_5[-1]
#
n_non_censored <- length(survival_non_censored)
#
data_Popes_second_approach <- list("n_non_censored",
                                   "z_censored",
                                   "t_censored",
                                   "x_1_censored",
                                   "x_2_censored",
