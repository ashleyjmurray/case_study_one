...
- If a Japanese Emperor is born 100 years later, he is expected to live longer by a multiplicative factor of $exp(9 \alpha_9) = exp(100*-0.0000595) = 0.994$, which means the lifespan decreases by 6%, whereas for Dalai Lama, the lifespan is expected to increase by a factor of exp(100*-0.0016203) = 0.85, or decrease by 15%. 
