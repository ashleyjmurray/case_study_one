---
title: "STA440 Case Study: Lifespans of World Leaders"
author: "Alice Liao, Ashley Murray, Cathy Lee, Matty Pahren"
data: "08/31/2020"
output: pdf_document
---
...
For example, while keeping all others constant, if a Pope is born one year later, he is expected to live longer by a multiplicative factor of $exp(\alpha_1)$, or his lifespan is expected to increase by a percentage of $100*exp(\alpha_1-1)$. If a U.S. President is born one year later, he is expected to live longer by a multiplicative factor of $exp(\alpha_1 + \alpha_6)$. If a U.S. President and a Chinese Emperor are born in the same year $y$, the Chinese emperor is expected to live longer by a multiplicative factor of $exp(\alpha_3 - \alpha_2 + (\alpha_7-\alpha_6)*y)$ and so on. 
...
```{r francis-dalai-plot, fig.height=2, fig.width=5, echo = FALSE}
...
```{r obama-naru-plot, fig.height=2, fig.width=5, echo = FALSE}
