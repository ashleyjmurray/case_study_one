...
- If a U.S. President and a Chinese Emperor were born in the same year 1700, 33 years after the centered the average birth year 1667, the Chinese emperor is expected to live longer by a multiplicative factor of $exp(\alpha_3 - \alpha_2 + (\alpha_7-\alpha_6)*y)$ = exp(-0.31925+0.1449877 + 33*(-0.0001094-0.0004852) = 0.82. That's to say, the Chinese emperor's life expectancy is 18% shorter. 
- If a Japanese Emperor and a Dalai Lama were born in the same year 1967, 300 years after the centered average birth year, the Japanese Emperor is expected to live longer by a multiplicative factor of $exp(\alpha_5 - \alpha_4 + (\alpha_9-\alpha_8)*y)$ = exp(-0.1723959+0.4038129 + 300*(-0.0000595+0.0016203)) = 2. This means the model suggests the Japanese Emperor is expected live 2 times of the lifespan of a Dalai Lama!
