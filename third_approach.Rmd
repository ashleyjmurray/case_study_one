...
The specific interpretation of these parameters depends on inputs from birth year and type of leadership. The below provides some examples. 

- A Japanese Emperor born in different centuries
```{r JapanEmp-diff-century}
