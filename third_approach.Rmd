...
```{r resid-v-year, fig.height=4, fig.width=10, echo = FALSE}
...
grid.arrange(p1, p2, left = "Standardized Residual", ncol=2,
             top ="Figure 4: Residual Plots", heights=c(2, 2))
```
...
```{r resid-v-yearcv, fig.height=4, fig.width=10, echo = FALSE}
p2 = ggplot(data = monarchs, aes(x = V2, y = resid/sd)) + geom_point() +
  labs(x = "Birth Year") +
  theme(axis.title.y = element_blank()) 

grid.arrange(p1, p2, left = "Standardized Residual", ncol=2,
             top ="Figure 7: Residual Plots for British Monarchs", heights(2, 2))
```
