...
ggplot(data = leaders_data) +
  geom_boxplot(aes(x = Type, y = Age.Event)) + ggtitle("Distribution of Leader Type and Their Age") + labs(x = "Type of Leader", y = "Age of Death/Censorship")
```

```{r, fig.height=2, fig.width=5,echo=F}
ggplot(data = leaders_data) +
  geom_histogram(aes(x = Age.Event), binwidth = 5) + ggtitle("Distribution of Leaders Age") + labs(x = "Age of Death Censorship")
```
