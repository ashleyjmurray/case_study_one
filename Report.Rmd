...
- Other Notes
 - Fix Dalai Lama
 - Cathy look at traceplots
 - everyone verify code
 
## Code 
- Model diagnostics 
  - posterior predictive checks (Ashley)
  - residual plots (standardized?) (Matty)
- Posterior Inference (answer questions)
  - sample many tries and average to get point/ interval estimate (Alice)
  - compare leaders (Cathy)
...
- Report Graphs/ Tables
  ...
  - Add other EDA plots? (anyone)
  - posterior distribution plots for 4 people of interest (Cathy)
  - tidy output table (Matty)
