...
- Matty: fix the model table output, fix the residuals again, see what's happening with the residuals. add explanation of the residual plots in the final report
